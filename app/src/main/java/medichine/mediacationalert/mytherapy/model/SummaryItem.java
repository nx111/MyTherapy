...
public class SummaryItem {
    ...
    public SummaryItem(String title, String subtitle, CharSequence details, String status,
    ...
    private SummaryItem(String title, String subtitle, CharSequence details, String status,
